...
try {
  ...
  // Apply CORS middleware directly to the route handlers
  app.use("/", cors(corsOptions), publicRoutes);
  app.use("/api", cors(corsOptions), webhookRoutes);
  app.use("/api/push", cors(corsOptions), pushRoutes);
  app.use("/api", cors(corsOptions), authenticateJWT, protectedRoutes);
