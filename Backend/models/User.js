...
      required: function () {
        // Only required if occupation is student AND the field has a value
...
      max: 12,
      required: function () {
        // Only required if occupation is student, not uni, AND the field has a value
...
      maxlength: 150,
      required: function () {
        // Only required if occupation is student, uni, AND the field has a value
...
      type: [String],
      required: function () {
        // Only required if occupation is teacher AND the field has a value
...
      ref: "School",
      required: function () {
        // Only required if occupation is student, teacher, or admin AND the field has a value
