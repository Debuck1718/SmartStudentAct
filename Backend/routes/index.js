/* routes/publicRoutes.js – Public API routes */
...
// --- Export a function that returns the router and accepts dependencies ---
module.exports = (eventBus, agenda) => {
    // ⚠️ Note: We no longer require('../utils/eventBus') here.
    // The eventBus instance is now passed as an argument from server.js.
